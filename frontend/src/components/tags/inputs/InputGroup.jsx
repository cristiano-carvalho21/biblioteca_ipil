...
function InputGroup({type, placeholder, onChange, page})
{
    return(
            <>
                {page === "home" ? (
                <form className="flex items-center border border-gray-100 rounded-md overflow-hidden w-full max-w-md
                    ...
                    <form className="flex items-center border border-gray-300 rounded-md overflow-hidden w-full
                        relative focus-within:ring-2 focus-within:ring-blue-500 transition">
